    ...
    return (
        <div className='min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
            <div className='sm:mx-auto sm:w-full sm:max-w-md'>
                <h2 className='mt-6 text-center text-3xl font-extrabold text-gray-900'>Register as a seller</h2>
            </div>
                        ...
                        <div>
                            ...
                            <div className='mt-2 flex items-center'>
                                ...
                                <label
                                    ...
                                    <input type='file' name='avatar' id='file-input' onChange={handleFileInputChange} className='sr-only' />
                                </label>
                            </div>
                        </div>
