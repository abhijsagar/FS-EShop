...
import { increaseQuantity, drecreaseQuantity, removeFromCart } from '../redux/slices/cartSlice';
            ...
            <View style={styles.content}>
                <View style={styles.row}>
                    ...
                    <View style={styles.remove}>
                        <TouchableOpacity color='#000' style={styles.removeButton} onPress={() => dispatch(removeItem(id))}>
                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.qtyAction}>
                        <TouchableOpacity style={styles.qtyMinusButton} onPress={() => dispatch(drecreaseQuantity(id))}>
                            <Text style={styles.minusIcon}>{'-'}</Text>
                        </TouchableOpacity>

                        <Text style={styles.qtyIcon}>{quantity < 10 ? '0' + quantity : quantity}</Text>

                        <TouchableOpacity style={styles.qtyPlusButton} onPress={() => dispatch(increaseQuantity(id))}>
