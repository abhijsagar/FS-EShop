...
const Checkout = () => {
    ...
    return (
        <div className='w-full flex flex-col items-center pt-8 pb-2'>
            <div className='w-full 1000px:w-[70%] block 800px:flex mx-2'>
...
const ShippingInfo = ({
    ...
    return (
        <div className='w-full 800px:w-[95%] bg-white rounded-md py-4 pb-8'>
            <form>
...
const CartData = ({ handleSubmit, totalPrice, shipping, subTotalPrice, couponCode, setCouponCode, discountPercentenge }) => {
    return (
        <div className='w-full bg-[#fff] rounded-md py-4 lg:p-4 pb-8'>
