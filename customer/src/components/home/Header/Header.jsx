...
import { navBarList, categoriesData } from '../../../static/index';
                    ...
                    <div>
                        {showMenu && (
                            <motion.ul
                                ...
                                className='flex items-center w-auto z-20 p-0 gap-2'>
                                <>
                                        ...
                                        <ul className='text-gray-200 flex flex-col gap-2'>
                                            {navBarList.map((item) => (
                                                <li
                                                    ...
                                                    key={item._id}>
                                                    <NavLink to={item.link} state={{ data: location.pathname.split('/')[1] }} onClick={() => setSidenav(false)}>
                                                        {item.title}
                                                    </NavLink>
                                                </li>
                                            ))}
                                                ...
                                                <motion.ul
                                                    ...
                                                    {categoriesData &&
                                                        categoriesData.map((i, index) => {
                                                            ...
                                                            return (
                                                                index < 5 && (
                                                                    <li key={i.id} onClick={() => handleSubmit(i)} className='headerSedenavLi'>
                                                                        {i.title}
                                                                    </li>
                                                                )
                                                            );
