                ...
                <div className='mx-auto space-y-4'>
                        ...
                        {activeTab === 2 && (
                            <div className='mt-4'>
                                <p className='text-base text-gray-500'>
                                    If you're not satisfied with your purchase, we accept returns within 30 days of delivery. To initiate a return, please email
                    ...
                    <div className='border-b border-gray-200 pb-4'>
                        ...
                        {activeTab === 4 && (
                            <div className='mt-4'>
                                <p className='text-base text-gray-500'>
                                    You can contact our customer support team by emailing us at support@myecommercestore.com, or by calling us at (555) 123-4567
                    ...
                    <div className='border-b border-gray-200 pb-4'>
                        ...
                        {activeTab === 5 && (
                            <div className='mt-4'>
                                <p className='text-base text-gray-500'>
                                    Unfortunately, once an order has been placed, we are not able to make changes or cancellations. If you no longer want the
                                    items you've ordered, you can return them for a refund within 30 days of delivery.
                                </p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className='border-b border-gray-200 pb-4'>
                        ...
                        {activeTab === 6 && (
                            <div className='mt-4'>
                                <p className='text-base text-gray-500'>Currently, we only offer shipping within the United States.</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className='border-b border-gray-200 pb-4'>
                        ...
                        {activeTab === 7 && (
                            <div className='mt-4'>
                                <p className='text-base text-gray-500'>We accept visa,mastercard,paypal payment method also we have cash on delivery system.</p>
                            </div>
                        )}
                    </div>
                </div>
