...
const Payment = () => {
    ...
    return (
        <div className='w-full flex flex-col items-center py-8'>
            <div className='w-full 1000px:w-[70%] block 800px:flex'>
                ...
                <div className='w-full 800px:w-[35%] 800px:mt-0 mt-4'>
                    ...
                    <div className='w-full flex border-b'>
                        <form className='w-full' onSubmit={paymentHandler}>
                            ...
                            <input
                                type='submit'
                                value='Submit'
                                className={'my-2 bg-primeColor text-white text-lg font-bodyFont w-[185px] h-[50px] hover:bg-black duration-300 font-bold'}
                            />
                        </form>
                    </div>
                ) : null}
