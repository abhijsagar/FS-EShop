        ...
        <div className='w-full h-[90vh] bg-white shadow-sm overflow-y-scroll sticky top-0 left-0 z-10'>
            ...
            <div className='w-full flex items-center p-4'>
                <Link to='/admin-sellers' className='w-full flex items-center'>
                    ...
                    <h5 className={`hidden 800px:block pl-2 text-[18px] font-[400] ${active === 3 ? 'text-[crimson]' : 'text-[#555]'}`}>All Sellers</h5>
                </Link>
            </div>

            <div className='w-full flex items-center p-4'>
                <Link to='/admin-users' className='w-full flex items-center'>
                    <HiOutlineUserGroup size={30} color={`${active === 4 ? 'crimson' : '#555'}`} />
                    <h5 className={`hidden 800px:block pl-2 text-[18px] font-[400] ${active === 4 ? 'text-[crimson]' : 'text-[#555]'}`}>All Users</h5>
                </Link>
            </div>
            ...
            <div className='w-full flex items-center p-4'>
                <Link to='/admin-products' className='w-full flex items-center'>
                    ...
                    <h5 className={`hidden 800px:block pl-2 text-[18px] font-[400] ${active === 5 ? 'text-[crimson]' : 'text-[#555]'}`}>All Products</h5>
                </Link>
            </div>
            ...
            <div className='w-full flex items-center p-4'>
                <Link to='/admin-events' className='w-full flex items-center'>
                    ...
                    <h5 className={`hidden 800px:block pl-2 text-[18px] font-[400] ${active === 6 ? 'text-[crimson]' : 'text-[#555]'}`}>All Events</h5>
                </Link>
            </div>
